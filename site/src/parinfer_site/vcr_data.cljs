   ...
   [{:change
    ...
    {:change
     {:from {:line 1, :ch 11},
      ...
      :origin "+input"},
     :dt 224}
    {:selections ({:anchor {:line 0, :ch 24}, :head {:line 0, :ch 24}}),
     :dt 1221}
    {:change
     {:from {:line 0, :ch 24},
      :to {:line 0, :ch 24},
    ...
    {:change
     {:from {:line 1, :ch 22},
      ...
      :origin "+input"},
     :dt 303}
    {:selections ({:anchor {:line 2, :ch 12}, :head {:line 2, :ch 12}}),
     :dt 1333}
    {:change
     {:from {:line 2, :ch 12},
      :to {:line 2, :ch 12},
    ...
    {:change
     {:from {:line 5, :ch 27},
      ...
      :origin "+input"},
     :dt 168}
    {:selections ({:anchor {:line 4, :ch 22}, :head {:line 4, :ch 22}}),
     :dt 1967}
    {:change
     {:from {:line 4, :ch 22},
      :to {:line 4, :ch 22},
    ...
    {:change
     {:from {:line 5, :ch 22},
      ...
      :origin "+input"},
     :dt 512}
    {:selections ({:anchor {:line 6, :ch 3}, :head {:line 6, :ch 3}}), :dt 2384}
    {:change
     {:from {:line 6, :ch 3},
      :to {:line 6, :ch 3},
      :text (" "),
    ...
    {:change
     {:from {:line 5, :ch 18},
      ...
      :origin "+input"},
     :dt 128}
    {:selections ({:anchor {:line 6, :ch 3}, :head {:line 6, :ch 3}}), :dt 1986}
    {:selections ({:anchor {:line 6, :ch 3}, :head {:line 6, :ch 4}}), :dt 181}
    {:selections ({:anchor {:line 6, :ch 3}, :head {:line 7, :ch 4}}), :dt 14}
    {:selections ({:anchor {:line 6, :ch 3}, :head {:line 7, :ch 35}}), :dt 19}
    {:change
     {:from {:line 6, :ch 0},
      :to {:line 6, :ch 3},
      :text ("     "),
    ...
    {:change
     {:from {:line 3, :ch 6},
      ...
      :origin "+input"},
     :dt 72}
    {:selections ({:anchor {:line 4, :ch 2}, :head {:line 4, :ch 2}}), :dt 1347}
    {:selections ({:anchor {:line 4, :ch 2}, :head {:line 5, :ch 3}}), :dt 190}
    {:selections ({:anchor {:line 4, :ch 2}, :head {:line 6, :ch 5}}), :dt 16}
    {:selections ({:anchor {:line 4, :ch 2}, :head {:line 7, :ch 6}}), :dt 17}
    {:selections ({:anchor {:line 4, :ch 2}, :head {:line 8, :ch 38}}), :dt 17}
    {:change
     {:from {:line 4, :ch 0},
      :to {:line 4, :ch 2},
      :text ("    "),
    ...
    {:change
     {:from {:line 8, :ch 0},
      ...
      :origin "+input"},
     :dt 7}
    {:selections ({:anchor {:line 8, :ch 41}, :head {:line 8, :ch 41}}),
     :dt 1624}],
   :init-value "",
     ...
     [{:selections ({:anchor {:line 0, :ch 0}, :head {:line 0, :ch 0}}),
      ...
      {:change
       {:from {:line 4, :ch 14},
        ...
        :origin "+input"},
       :dt 116}
      {:selections ({:anchor {:line 4, :ch 17}, :head {:line 4, :ch 17}}),
       :dt 1117}
      {:change
       {:from {:line 4, :ch 17},
        :to {:line 4, :ch 17},
      ...
      {:change
       {:from {:line 5, :ch 14},
        ...
        :origin "+input"},
       :dt 233}
      {:selections ({:anchor {:line 5, :ch 12}, :head {:line 5, :ch 12}}),
       :dt 1184}
      {:selections ({:anchor {:line 5, :ch 12}, :head {:line 5, :ch 15}}),
       :dt 120}
      {:selections ({:anchor {:line 5, :ch 0}, :head {:line 5, :ch 17}}),
       :dt 145}
      {:change
       {:from {:line 5, :ch 0},
        :to {:line 5, :ch 17},
        ...
        :origin "+delete"},
       :dt 336}
      {:selections ({:anchor {:line 4, :ch 13}, :head {:line 4, :ch 13}}),
       :dt 939}
      {:selections ({:anchor {:line 4, :ch 12}, :head {:line 4, :ch 15}}),
       :dt 143}
      {:selections ({:anchor {:line 4, :ch 0}, :head {:line 5, :ch 0}}),
       :dt 350}
      {:change
       {:from {:line 4, :ch 0},
        :to {:line 5, :ch 0},
