...
Parinfer.reader = (function(){
  ...
  return {
    matchingDelim: matchingDelim,
    isOpenDelim: isOpenDelim,
    isCloseDelim: isCloseDelim,
    isWhitespace: isWhitespace,
    peek: peek,
    prevCh: prevCh,
    isEscaping: isEscaping,
    prevNonEscCh: prevNonEscCh,
    isInStr: isInStr,
    isInComment: isInComment,
    isInCode: isInCode,
    isValidCloser: isValidCloser,
    pushChar: pushChar,
  };
