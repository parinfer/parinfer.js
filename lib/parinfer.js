...
function onIndent(result) {
  // TODO: for each opener to close with a indentedComment, insert a paren trail line with onIndent?
  // TODO: remove indentedComment from each opener not containing this indentation point
