...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__16883__auto__,k47896,else__16884__auto__){
var self__ = this;
var this__16883__auto____$1 = this;
var G__47898 = (((k47896 instanceof cljs.core.Keyword))?k47896.fqn:null);
switch (G__47898) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k47896,else__16884__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__16888__auto__,k__16889__auto__,G__47895){
var self__ = this;
var this__16888__auto____$1 = this;
var pred__47899 = cljs.core.keyword_identical_QMARK_;
var expr__47900 = k__16889__auto__;
if(cljs.core.truth_(pred__47899.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__47900))){
return (new ajax.protocols.Response(G__47895,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__47899.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__47900))){
return (new ajax.protocols.Response(self__.status,G__47895,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__47899.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__47900))){
return (new ajax.protocols.Response(self__.status,self__.body,G__47895,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__47899.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__47900))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__47895,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__47899.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__47900))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__47895,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__16889__auto__,G__47895),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__16880__auto__,G__47895){
var self__ = this;
var this__16880__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__47895,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__47897){
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__47897),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__47897),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__47897),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__47897),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__47897),null,cljs.core.dissoc.call(null,G__47897,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)),null));
});


//# sourceMappingURL=protocols.js.map?rel=1445965101583